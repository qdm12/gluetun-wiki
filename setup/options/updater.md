...
| `UPDATER_PROTONVPN_USERNAME` | | Your Proton username | If you need paid servers data, you must use a paid account. Otherwise I recommend creating a free throwaway accounts for this. |
| `UPDATER_PROTONVPN_PASSWORD` | | Your Proton password | If you need paid servers data, you must use a paid account. Otherwise I recommend creating a free throwaway accounts for this. |
