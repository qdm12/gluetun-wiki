...
| `UPDATER_PROTONVPN_USERNAME` | | Your Proton username | I highly recommend creating a free throwaway account for this. |
| `UPDATER_PROTONVPN_PASSWORD` | | Your Proton password | I highly recommend creating a free throwaway account for this. |
