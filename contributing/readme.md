...
- Locally: your credentials would be stored in an encrypted file using [https://github.com/qdm12/gluetun/tree/master/devrun](https://github.com/qdm12/gluetun/tree/master/devrun) which decrypts only in memory the credentials to stuff them in an in-memory container configuration (using Moby/Docker Go libraries). I'm already using this now.
